...
/// <summary>
/// A service for publishing events and announcements, and getting published events and announcements.
/// </summary>
public interface IPublishingService
{
    ...
    /// <see cref="CustomStatusCode.DuplicateKey"/> if the event is already published,
    ...
    /// <returns>Status code <see cref="CustomStatusCode.EventNotFound"/> if event is not currently published</returns>
    ...
    /// <returns>Status code <see cref="CustomStatusCode.CampaignNotFound"/> if the campaign does not exist.</returns>
    ...
    /// <returns>In item 1: Status code <see cref="CustomStatusCode.CampaignNotFound"/> if the campaign does not exist,
    /// <see cref="CustomStatusCode.UserNotFound"/> if publisher id is not a valid user.<br/>
    ...
    /// <returns>Status code <see cref="CustomStatusCode.AnnouncementNotFound"/> if the announcement does not exist.</returns>
