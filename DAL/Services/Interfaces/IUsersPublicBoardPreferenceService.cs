...
public interface IUsersPublicBoardPreferenceService
{
    ...
    /// PreferenceNotFound if the user does not have a preference for this campaign.</returns>
    ...
    /// <returns>Item 1: Status code UserNotFound if the user does not exist.<br/>
