...
public class UsersPublicBoardPreferenceServiceTests
{
    ...
    public void AddPreference_ShouldReturnOk_WhenPreferenceAdded()
    {
        ...
        // Act
        var statusCode = _usersPublicBoardPreferenceService
            .AddPreference(_user.UserId, _campaign.CampaignGuid.Value, true).Result;
    ...
    public void AddPreference_ShouldFailForDuplicateKey_WhenPreferenceAlreadyExistsWithDifferentValue()
    {
        ...
        // Act
        var statusCode = _usersPublicBoardPreferenceService
            .AddPreference(_user.UserId, _campaign.CampaignGuid.Value, false).Result;
    ...
    public void AddPreference_ShouldFailForWrongUserId_WhenUserDoesNotExist()
    {
        ...
        // Act
        var statusCode = _usersPublicBoardPreferenceService.AddPreference(-1, _campaign.CampaignGuid.Value, true)
            .Result;
    ...
    public void UpdatePreference_ShouldReturnOk_WhenPreferenceUpdated()
    {
        ...
        // Act
        var statusCode = _usersPublicBoardPreferenceService
            .UpdatePreference(_user.UserId, _campaign.CampaignGuid.Value, false).Result;
    ...
    public void UpdatePreference_ShouldFailForWrongUserId_WhenUserDoesNotExist()
    {
        ...
        // Act
        var statusCode = _usersPublicBoardPreferenceService.UpdatePreference(-1, _campaign.CampaignGuid.Value, true)
            .Result;
    ...
    public void DeletePreference_ShouldReturnOk_WhenPreferenceDeleted()
    {
        ...
        // Act
        var statusCode = _usersPublicBoardPreferenceService.RemovePreference(_user.UserId, _campaign.CampaignGuid.Value)
            .Result;
    ...
    public void UpdatePreference_ShouldFailForWrongCampaignGuid_WhenPreferenceDoesNotExist()
    {
        ...
        // Act
        var statusCode = _usersPublicBoardPreferenceService
            .UpdatePreference(_user.UserId, _campaign.CampaignGuid.Value, true).Result;
