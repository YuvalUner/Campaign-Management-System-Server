...
public class JobPreferencesServiceTests
{
    ...
    public void GetUserPreferencesShouldReturnNull()
    {
        ...
        // Act
        var userPreferences = _jobPreferencesService.GetUserPreferences(testUser.UserId, testCampaign.CampaignGuid.Value).Result;
    ...
    public void AddUserPreferencesShouldWork()
    {
        ...
        // Act
        _jobPreferencesService.AddUserPreferences(testUser.UserId, testCampaign.CampaignGuid.Value, testUserJobPreference.UserPreferencesText).Wait();
    ...
    public void UpdateUserPreferencesShouldWork()
    {
        ...
        // Act
        _jobPreferencesService.UpdateUserPreferences(testUser.UserId, testCampaign.CampaignGuid.Value, testUserJobPreference.UserPreferencesText).Wait();
