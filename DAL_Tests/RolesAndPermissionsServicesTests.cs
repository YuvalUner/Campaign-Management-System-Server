...
/// <summary>
/// A collection of tests for the <see cref="IRolesService"/> and <see cref="IPermissionsService"/> interfaces and their implementations,
/// <see cref="RolesService"/> and <see cref="PermissionsService"/>.<br/>
...
public class RolesAndPermissionsServicesTests
{
    ...
    public void AddPermissionShouldWork()
    {
        ...
        // Act
        var result = _permissionsService.AddPermission(testPermission, OtherUser.UserId, testCampaign.CampaignGuid)
            .Result;
    ...
    public void AddRoleShouldWork()
    {
        ...
        // Act
        var result = _rolesService
            .AddRoleToCampaign(testCampaign.CampaignGuid, testRole.RoleName, testRole.RoleDescription).Result;
    ...
    public void AddNormalRoleToUserShouldWork()
    {
        ...
        // Act
        var result = _rolesService.AssignUserToNormalRole(testCampaign.CampaignGuid, OtherUser.Email, testRole.RoleName)
            .Result;
    ...
    public void AddNormalRoleToUserShouldFailForRoleNotFound()
    {
        ...
        // Act
        var result = _rolesService.AssignUserToNormalRole(testCampaign.CampaignGuid, OtherUser.Email, "WrongRole")
            .Result;
    ...
    public void AddNormalRoleToUserShouldFailForUserNotFound()
    {
        ...
        // Act
        var result = _rolesService.AssignUserToNormalRole(testCampaign.CampaignGuid, "WrongUser", testRole.RoleName)
            .Result;
    ...
    public void AddAdminRoleToUserShouldWork()
    {
        ...
        // Act
        var result = _rolesService
            .AssignUserToAdministrativeRole(testCampaign.CampaignGuid, OtherUser.Email, managerRole.RoleName).Result;
    ...
    public void AddAdminRoleToUserShouldFailForRoleNotFound()
    {
        ...
        // Act
        var result = _rolesService
            .AssignUserToAdministrativeRole(testCampaign.CampaignGuid, OtherUser.Email, "WrongRole").Result;
    ...
    public void AddAdminRoleToUserShouldFailForUserNotFound()
    {
        ...
        // Act
        var result = _rolesService
            .AssignUserToAdministrativeRole(testCampaign.CampaignGuid, "WrongUser", managerRole.RoleName).Result;
